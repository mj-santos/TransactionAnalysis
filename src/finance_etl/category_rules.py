...
BUILT_IN_CATEGORY_MAP: dict[str, tuple[str, str]] = {
    ...
    "Landscaping":                                  ("Landscaping",                      "Property Improvement Expense"),
    "Lawn & Garden":                                ("Landscaping",                      "Property Improvement Expense"),
    "Hardscaping":                                  ("Hardscaping",                      "Property Improvement Expense"),
    "Irrigation":                                   ("Irrigation",                       "Property Improvement Expense"),
    "Sprinkler System":                             ("Irrigation",                       "Property Improvement Expense"),
    "Lighting":                                     ("Lighting",                         "Property Improvement Expense"),
    "Outdoor Lighting":                             ("Lighting",                         "Property Improvement Expense"),
    "Fencing":                                      ("Fencing",                          "Property Improvement Expense"),
    "Tree Removal":                                 ("Tree Removal / Tree Planting",     "Property Improvement Expense"),
    "Tree Service":                                 ("Tree Removal / Tree Planting",     "Property Improvement Expense"),
    "Ground Preparation":                           ("Ground Preparation / Grading",     "Property Improvement Expense"),
    "Grading":                                      ("Ground Preparation / Grading",     "Property Improvement Expense"),
    "Drainage":                                     ("Drainage",                         "Property Improvement Expense"),
    "Outdoor Structures":                           ("Outdoor Structures",               "Property Improvement Expense"),
    "Deck & Patio":                                 ("Outdoor Structures",               "Property Improvement Expense"),
    "Exterior Painting":                            ("Exterior Painting & Staining",     "Property Improvement Expense"),
    "Exterior Staining":                            ("Exterior Painting & Staining",     "Property Improvement Expense"),
    # ── Other ────────────────────────────────────────────────────────────────
